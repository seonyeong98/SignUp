...
class RegionCode extends Component {
    ...
    searchAddress = () => {
        ...
        */
        ...
        axios.get(`/v2/local/geo/coord2regioncode?x=${x}&y=${y}`)
        .then(res => {
            console.log(res);
            this.setState({
                //address: res.data,
    ...
    render() {
        ...
        return(
            ...
            <input type="text" placeholder="y좌표" name="y_coord" onChange={this.handleInputY} onKeyPress={(e) => { if (e.key == 'Enter') this.searchAddress()}}/>
